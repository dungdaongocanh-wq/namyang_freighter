...
$menus = [
  'cs' => [
    ...
    ['shared.delivery_board',     '📬', 'Bảng giao hàng'],
  ...
  'accounting' => [
    ...
    ['quotation.index',           '📝', 'Báo giá'],
    ['statement.index',           '📊', 'Bảng kê chi tiết'],
  ],
  'customer' => [
    ['label' => 'KHÁCH HÀNG', 'type' => 'header'],
  ...
  'admin' => [
    ...
    ['label' => 'BÁO CÁO', 'type' => 'header'],
    ['report.export',             '📥', 'Xuất báo cáo'],
    ['report.shipment',           '📊', 'BC Lô đã xác nhận'],
    ['report.ops_costs',          '👷', 'BC Chi phí OPS'],
    ...
    ['admin.cost_groups',         '🏷️',  'Nhóm chi phí'],
...
<main id="main-content">
  ...
  $errMap = [
    ...
    'in_use'      => 'Dữ liệu đang được sử dụng, không thể xoá!',
  ];
